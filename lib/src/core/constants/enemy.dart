...
final Map<String,List<Enemy>> ultraEnemies = {
    '@ULTRAMAN': [
      ...
      Enemy(
        ...
        'Siendo un peligroso fugitivo intergaláctico, su arribo a nuestro planeta fue tan aparatoso que incluso provocó la muerte de un inocente. Escondido en un lago para recuperar energías, estaba dispuesto a eliminar a cualquiera que osara irrumpir en la zona. En su batalla contra Ultraman, mostró resistencia al no querer ser nuevamente aprisionado, pero finalmente cayó bajo el novedoso Rayo Specium. Oficialmente, es el primer enemigo que Ultraman derrotó en su llegada a la Tierra.',
        ...
        aliasOf: 'El Monstruo Espacial',
        height: '50m',
        weight: '25,000T',
        planet: 'Planeta M35',
        ultra: '@ULTRAMAN',
        comentary: '“Debía detenerlo antes de que llegara a la Tierra. No contaba con que sería el inicio de una gran aventura que me haría sentir aprecio por la humanidad.”',
      ...
      Enemy(
        'Alien Baltan',
        'El Errante Invasor',
        'Habitantes de un planeta extinto debido a pruebas nucleares, vagaban por el universo en busca de un planeta habitable. Llegaron a la Tierra mediante un aterrizaje forzoso; sin embargo, se llevaron la grata sorpresa de que nuestro planeta ofrecía lo que ellos deseaban en un nuevo mundo. Sus habilidades ilusorias fueron suficientes para superar a los humanos, pero, para su mala suerte, la Tierra estaba protegida por otro ser alienígena de gran poder.',
        //Imágenes Principales
        ...
        aliasOf: 'El Ninja Espacial',
        height: 'Microscópico ~ 50m',
        weight: '0.0 ~ 15,000T',
        planet: 'Extinto',
        ultra: '@ULTRAMAN',
        comentary: '“Les ofrecí coexistir con los humanos, pero revelaron sus verdaderos colores. Tras frustrar su intento de invasión, tuve que eliminar su nave nodriza para proteger a la humanidad. Son enemigos formidables y muy resistentes.”',
      ...
      Enemy(
        ...
        'Los registros del antiguo Japón contaban la historia de una bestia que había sido sellada por un antiguo y poderoso samurai. Desde aquel momento, la criatura se mantendría en letargo mientras se desarrollaba cada vez más con el paso del tiempo. Eventualmente, el continuo avance tecnológico de los humanos haría que el alimento de Neronga escaseara. Resurgiendo y atacando algunas plantas eléctricas, su encuentro y derrota a manos de Ultraman fueron inevitables.',
        //Imágenes Principales
      ...
      Enemy(
        'Greenmons',
        'La Muerte Orgánica',
        'Originalmente parte de la flora perteneciente a las costas de Japón, se usó en una serie de experimentos que resultaron en un espécimen con desarrollo acelerado. Como consecuencia, Greenmons despertó cierta consciencia además de un fuerte sentido de venganza hacia aquellos involucrados en su desviación natural. Sus deseos asesinos aumentaron a la par de su colosal figura, por lo que Ultraman debía enfrentarlo directamente.',
        ...
        planet: 'La Tierra\n(Isla Oirisu)',
        ultra: '@ULTRAMAN',
        comentary: '“La experimentación es vital para el desarrollo de una civilización, sin embargo, si no se hace con debido respeto puede provocar una reacción adversa. No deseo pensar en lo que hubiese pasado con la humanidad de no intervenir.”', 
        imgDrawer: 'assets/005_greenmons_2.webp',
      ),
      Enemy(
        'Gesura',
        'El Kaiju Latinoamericano',
        'Proveniente de Latinoamérica, Gesura es una terrorífica leyenda conocida por todos los marineros respetados. Acusado de hundir un sinfín de navíos, los relatos hablan de cómo, a través de este terrible acto, lograba calmar su hambre voraz. En un momento se llegaría a conocer la predilección de Gesura por el cacao, de modo que todo navío que lo transportara en su hábitat estaría en peligro. El Héroe de colores Rojo y Plata consiguió vencerlo, pero no antes de recibir una buena muestra de su factor venenoso.',
        ...
        planet: 'La Tierra\n(Brasil ~ Yokohama)',
        ultra: '@ULTRAMAN',
        comentary: '“Es impresionante que la Tierra albergue criaturas tan colosales; sin duda, supone un problema para las embarcaciones que transportaban su alimento predilecto. Al enfrentarlo, reconozco que su emisión de veneno es capaz de hacer mermar mis energías.”.',
        imgDrawer: 'assets/006_gesura_2.webp'
      ),
      Enemy(
        'Antlar',
        'El Verdugo Ancestral',
        'Esta ancestral criatura sometió a una antigua civilización que había perdido a su protector hacía mucho tiempo. Cuando la patrulla científica intentó detenerlo, su ira se desató, poniendo en riesgo a los habitantes. En su batalla contra Ultraman, demostró su increíble resistencia; de no ser por un regalo místico dejado atrás por un legendario héroe, posiblemente Ultraman habría tenido muchos problemas. Sorprendentemente, es el primer enemigo en resistir completamente el poder de un Rayo Specium.',
        ...
        comentary: '“Es difícil de creer, pero parece que un antecesor mío protegió la ciudad que este ser aterrorizaba sin fin. Espero poder conocerlo para rendirle mi más profundo respeto. Un momento... ¿Sabía que el Rayo Specium no serviría contra Antlar?”'
      ),
      Enemy(
        'Red King',
        'El Kaiju Berserk',
        'En una isla remota, un conjunto de criaturas bestiales se enfrentan, pero solo una es capaz de emerger como el vencedor. Siendo una monstruosidad de poder incontrolable, toda acción que realizara parecía poseer un componente asesino. Lamentablemente para él y su fuerza imparable, se topó con un rival capaz de usar sus fortalezas contra él mismo, concluyendo en una apabullante derrota. Sin duda, la criatura más bárbara y físicamente poderosa que alguna vez habitó la Tierra.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Isla Tatara)',
        ultra: '@ULTRAMAN',
        comentary: '“Cuenta con un poder físico impresionante. De no contar con mi entrenamiento especial para contrarrestar sus embestidas, sería casi invencible. Debo estar agradecido por su escasa inteligencia.”',
        imgDrawer: 'assets/008_redking_2.webp'
      ),
      Enemy(
        'Gabora',
        'El Devorador Radioactivo',
        'De los Kaijus más peligrosos que habitaron la Tierra en la edad contemporánea, Gabora emergió desde el subsuelo tras una tormenta arrasadora. Si bien su presencia ya causaba estragos en pueblos aledaños, mayor sería la preocupación al descubrir su alimento predilecto: el uranio. Al igual que Neronga, su presencia era incompatible con los avances tecnológicos de la humanidad. Depósitos de uranio comprometidos causarían un efecto nefasto para la naturaleza. Ultraman debía intervenir antes de presenciar un horror inimaginable.',
         //Imágenes Principales
        ...
        aliasOf: 'El Monstruo de Uranio',
        height: '50m',
        weight: '25,000T',
        planet: 'La Tierra (Tokio)',
        ultra: '@ULTRAMAN',
        comentary: '“Una criatura de esta naturaleza haría peligrar a toda civilización de tipo I. Dado que se alimenta de uranio, me temo que su existencia es, por lo menos, incómoda para el medio ambiente. ¿Será posible que existan más especímenes de estos por el universo?”',
        imgDrawer: 'assets/009_gabora_2.webp'
      ),
      Enemy(
        'Jirahs',
        'El Aberrante Experimento',
        'Conocida es la leyenda del monstruo del Lago Ness, sin embargo, ¿quién te dijo que era solo una leyenda? Un reconocido y renombrado científico lograría estudiar a esta majestuosa criatura para dominarla. A través de diferentes experimentos, lograría engendrar lo que conocemos como Jirahs, un increíble Kaiju muy parecido al que llaman “Rey de los Monstruos”. Tras revelarse contra su amo, Jirahs enfrentaría a Ultraman en una de las batallas más tortuosas y bizarras de la serie.',
         //Imágenes Principales
        ...
        aliasOf: 'El Dinosaurio Superior',
        height: '45m',
        weight: '20,000T',
        planet: 'La Tierra\n(Lago Ness ~ Kiyatama)',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        'Gango',
        'El Monstruo Onírico',
        'De origen lovecraftiano, Gango es una manifestación de una mente villanesca y retorcida. Desde los cielos, un extraño elemento aterrizaría en la Tierra. Tras ser analizado, se confirmaría que es capaz de interactuar con seres inteligentes para manifestar sus deseos inmediatos. Una vez que Gango es plasmado en la realidad, entra en descontrol, combatiendo así contra Ultraman. Finalmente, su creador lograría recobrar la lucidez y deshacer su existencia.',
         //Imágenes Principales
      ...
      Enemy(
        'Mummy Man',
        'El Amo Ancestral',
        'Antiguo ser terrestre de hace milenios, fue descubierto en la edad contemporánea por un grupo de científicos. Tras diversos intentos de investigación en las instalaciones donde yacía el supuesto cuerpo, se canalizaría energía eléctrica suficiente para reanimar a la aterradora momia. Siendo el verdugo de múltiples vidas humanas, se le intentó contener hasta que su existencia se volvió insostenible. Finalizando su vida con un grito gutural, despertaría a una peligrosa criatura legendaria.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Okutama)',
        ultra: '@ULTRAMAN',
        comentary: '“Los humanos antiguos se las arreglaron para conservar un cuerpo a tal punto de poder ser reanimado. Desconozco mucho de su cultura antigua, pero es posible que haya sido una figura importante. Aún así, cualquier distorsión entre la vida y la muerte solo puede traer pesares.”',
        imgDrawer: 'assets/012_mummy_man_2.webp'
      ),
      Enemy(
        'Dodongo',
        'El Equino Dracónico',
        'Contraparte simbiótica de una momia antigua, es posible que fuera el protector de su amo antepasado. Muerta su figura superior, Dodongo se dispuso a plasmar su venganza contra esta nueva era; destruyendo todo a su paso, llegó a una mina donde aterrorizaría a los trabajadores. La Patrulla Científica hizo lo posible para detenerlo, propinándole daño, pero finalmente contaron con Ultraman para darle un triste pero necesario tiro de gracia.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Okutama)',
        ultra: '@ULTRAMAN',
        comentary: '“Son obvias las razones, pero son pocas las criaturas del universo que permitan cabalgar a los de mi especie. Fue una experiencia novedosa, he de admitir. Lástima que este sirviente sin rumbo terminó convirtiéndose en un peligro incontrolable.”.',
        imgDrawer: 'assets/013_dodongo_2.webp'
      ),
      Enemy(
        'Pestar',
        'La Estrella Petrófaga',
        'Habitante de las profundidades y petrófago por excelencia, Pestar es potencialmente la criatura más peligrosa que alguna vez habitó el océano. Debido a sus constantes intersecciones con navíos o centrales petroleras, la contaminación marina iba en alarmante ascenso. Curiosamente, Ultraman tuvo que lidiar más con las consecuencias de este monstruo que contra él mismo.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Profundidades)',
        ultra: '@ULTRAMAN',
        comentary: '“De alguna forma, esta criatura logró transformar combustibles fósiles en parte de su alimento. Dejarlo sin represalias supondría un desastre ambiental irreparable y atacarlo con vehemencia podría suponer una reacción en cadena incontrolable. Ante estos casos, es mejor ir codo a codo con la humanidad.”',
        imgDrawer: 'assets/014_pestar_2.webp'
      ),
      Enemy(
        'Gamakugira',
        'El Cetáceo Mounstruoso',
        'La figura de un cetáceo monstruoso se asomaba por las costas de Japón. Dispuesto a diezmar todas las ostras de las inmediaciones para alimentarse de sus perlas, Gamakugira fue un peligro que llevó a la Patrulla Científica a emplear múltiples vías de acción, entre ellas, colocar un cohete en la "retaguardia" del Kaiju. Por más ridículo que suene, es así que Ultraman logró interceptarlo en el aire, haciéndolo explotar en pedazos...',
         //Imágenes Principales
      ...
      Enemy(
        ...
        planet: 'La Tierra\n(Rayos Cósmicos)',
        ultra: '@ULTRAMAN',
        comentary: '“Escuchar a aquellos niños rogar por proteger a su creación me conmovió; supongo que sentían que de alguna forma era su responsabilidad. Si bien no pude dejarlo en la Tierra debido a los diferentes problemas que causaría, me encargué de inmortalizar su existencia en el cosmos.”',
        imgDrawer: 'assets/016_gavadon_2.webp'
      ),
      Enemy(
        'Alien Baltan II',
        'La Reencarnación de la Venganza',
        "Tras su primer encuentro con Ultraman en la Tierra, los Baltan's sobrevivientes consiguieron replegarse en un planeta llamado “R”, donde formularon su venganza. El objetivo era separar a Ultraman de la Tierra para atacarlo por dos frentes. Primero secuestrando una nave espacial y llevándola a su nuevo planeta, y segundo atacando un aeropuerto con gran concurrencia. Sin embargo, Ultraman, ya mucho más experimentado como héroe terrestre, logró resolverlo de forma magistral.",
         //Imágenes Principales
        ...
        aliasOf: 'El Baltan Segundo',
        height: 'Microscópico ~ 50m',
        weight: '0 ~ 15,000T',
        planet: 'Planeta R',
        ultra: '@ULTRAMAN',
        comentary: '“Si bien crearon un plan exhaustivo para mantenerme alejado de la acción, no contaron con mi poderosa pero extenuante habilidad de teletransportación. Igual debo admitir que estudiaron muy bien cómo contrarrestar alguna de mis técnicas.”',
      ...
      Enemy(
        ...
        'Un amigable alienígena aparece en la ciudad de Tokio para salvar a la población. ¡Patrañas! Este aterrador ser solo deseaba ganarse el favor de la humanidad. Pasando por la Patrulla Científica hasta los altos mandos de Japón, su objetivo era sembrar la discordia en cuanto al rol de Ultraman como héroe, siendo el primer paso para que los humanos se destruyeran a sí mismos, todo por mera diversión. Para su mala suerte, existen humanos que confían ciegamente en Ultraman, lo cual le permitió limpiar su nombre acabando con el impostor más peligroso de la Galaxia.',
         //Imágenes Principales
      ...
      Enemy(
        'Aboras & Banila',
        'El Dúo Infernal',
        'Dos figuras demoníacas eran el terror de alguna civilización anterior a la nuestra. De alguna forma, lograron capturarlas en cápsulas diferentes. Dado que la advertencia para mantener selladas las cápsulas estaba en un idioma antiguo, la curiosidad de los humanos fue mucho mayor. Con ambas figuras traídas a la actualidad, era solo cuestión de tiempo para que arrasaran con el país. Aunque fuera de todo pronóstico, estas dos bestias se enfrentarían, dando como ganadora a la contraparte Azul. Es así que Ultraman debía enfrentar al Alfa de este par de Kaijus, empleando 3 Rayos Specium consecutivos.',
         //Imágenes Principales
        ...
        ultra: '@ULTRAMAN',
        comentary: '“Fueron el terror de alguna civilización. De haberme enfrentado a ellas como un equipo, es posible que hubiese visto el abismo de la derrota. Para nuestra fortuna, estas criaturas parecen ser antagónicas la una con la otra.”',
        imgDrawer: 'assets/020_aboras_banila_2.webp'
      ),
      Enemy(
        'Hidora',
        'El Avatar Dragón',
        'De origen sobrenatural, Hidora es la manifestación terrenal de la imaginación (o no) de un niño fallecido en un accidente automovilístico. Siguiendo su voluntad espiritual, este dragón pondría en peligro a múltiples vehículos en la ruta 87. Ultraman intervendría como siempre, pero esta era una batalla que no se podía resolver con violencia, solo se podría mediante la justicia suficiente para que el pequeño joven descansara en paz.',
         //Imágenes Principales
        ...
        aliasOf: 'El Dragón de las Altas\nTierras',
        height: '60m',
        weight: 'Clasificado',
        planet: 'La Tierra\n(Omuroyama)',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        'Kemular',
        'El Anfibio Venenoso',
        'Residente de un volcán inactivo, Kemular posee la misma categoría que Gabora en cuanto a peligrosidad ambiental. Su gas venenoso era suficiente para contaminar el aire circundante, causando inconsciencia y, en un lapso más prolongado, la muerte. Siendo una bestia agresiva y letal, se necesitó del ejército, la Patrulla Científica y a Ultraman para detener tal amenaza.',
         //Imágenes Principales
        ['assets/022_kemular_0.webp','assets/022_kemular_1.webp','assets/022_kemular_3.webp'],
        //Habilidades del Kaiju
        {'':'assets/kaiju_habs.webp', '-': 'assets/kaiju_habs_1.webp'},
        color: Color.fromARGB(255, 51, 82, 103),
        aliasOf: 'El Mounstruo de Gas\nVenenoso',
        height: '35m',
        weight: '10,000T',
        planet: 'La Tierra (Cráter \nKyushu)',
        ultra: '@ULTRAMAN',
        comentary: '“Para ser una criatura cuadrúpeda, es especialmente inteligente y resistente. Su gas tóxico es temible. No me sorprende que habite en una zona de gases volcánicos.”',
        imgDrawer: 'assets/022_kemular_2.webp'
      ),
      Enemy(
        'Telesdon',
        'El Verdugo Subterráneo',
        'En la superficie terrestre, la especie dominante es la humana, pero ¿qué hay debajo de nosotros? Esta criatura es aliada y defensora de los llamados habitantes subterráneos, los cuales, mediante un plan elaborado, planeaban manipular a Ultraman para sumarlo como recurso a la hora de dominar la superficie. No obstante, Ultraman suele ser incorruptible, por lo que a la primera posibilidad, iría en contra de este Kaiju habitante del subsuelo.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Subsuelo)',
        ultra: '@ULTRAMAN',
        comentary: '“Aquellos seres subterráneos fueron capaces de capturar e hipnotizar a mi contraparte humana. Afortunadamente, ese tipo de estados no son transferibles a la hora de adquirir mi forma alienígena.”',
      ...
      Enemy(
        ...
        aliasOf: 'El Anterior Habitante\nde la Tierra',
        height: '50m',
        weight: '10,000T',
        planet: 'La Tierra\n(Interacción Cósmica)',
        ultra: '@ULTRAMAN',
        comentary: '“Aún cuando la venganza no es el camino de un Ultra, puedo comprender el sentir de esta criatura. Usar a seres vivos como recursos para lograr hitos científicos inmediatos es despreciable. No hubo orgullo alguno en la batalla... solo una desoladora tristeza.”',
        imgDrawer: 'assets/024_jamila_2.webp'
      ),
      Enemy(
        'Gubira',
        'La Criatura Subacuática Taladrante',
        'Instalaciones submarinas eran atacadas por una terrible criatura de las profundidades. Gubira, un Kaiju de naturaleza agresiva y territorial, obligó a emplear tácticas de rescate para el personal en las instalaciones. Ultraman perseguiría a este Kaiju hasta llegar a la superficie, donde tendría que enfrentar su peligrosa arma capaz de penetrar la corteza terrestre.',
         //Imágenes Principales
        ['assets/025_gubira_0.webp','assets/025_gubira_1.webp','assets/025_gubira_3.webp'],
        //Habilidades del Kaiju
        {'':'assets/kaiju_habs.webp', '-': 'assets/kaiju_habs_1.webp'},
        color: Color.fromARGB(255, 156, 146, 89),
        aliasOf: 'El Mounstruo del Mar\nProfundo',
        height: '50m',
        weight: '35,000T',
        planet: 'La Tierra\n(Profundidades)',
        ultra: '@ULTRAMAN',
        comentary: '“Me impresionó su capacidad para adaptarse a entornos terrestres. Mientras ostentara su cuerno, técnicas como el Ultra-Slash serían inútiles. Quién diría que su arma más peligrosa terminaría siendo su punto más débil.”',
      ...
      Enemy(
        ...
        aliasOf: 'El Redking Segundo',
        height: '45m',
        weight: '20,000T',
        planet: 'La Tierra\n(Alpes Japoneses)',
        ultra: '@ULTRAMAN',
        comentary: '“La imaginación es vital para la supervivencia de un guerrero. Tuve que combinar mi poder de telequinesis y mi Ultra-Slash en un intento por desactivar las bombas sin comprometer la Tierra.”',
        imgDrawer: 'assets/026_redking_II_2.webp'
      ),
      Enemy(
        'Gomora',
        'El Príncipe de los Monstruos',
        'El mayor hallazgo paleontológico hecho por la humanidad. Este antiguo pariente vivo de los dinosaurios sería sedado y trasladado a un museo para exponerlo. No obstante, en medio del viaje, el Kaiju lograría despertar y liberarse. Ultraman le plantaría cara, pero contra todo pronóstico, se llevaría su primera derrota. Tras múltiples acontecimientos, Gomora amenazaría los castillos de Osaka y mediante una extenuante batalla contra las fuerzas de defensa, lograrían debilitarlo para que así Ultraman logre su merecida revancha.',
         //Imágenes Principales
        ...
        planet: 'La Tierra\n(Islas Johnson)',
        ultra: '@ULTRAMAN',
        comentary: '“No puedo imaginar un Kaiju más completo en términos de combate. Tanto el uso de sus cuernos como de su cola son magistrales. Para salir victorioso en una batalla cuerpo a cuerpo, debería usar mis ataques de lanzamiento con una precisión casi demencial.”',
        imgDrawer: 'assets/027_gomora_2.webp'
      ),
      Enemy(
        'Alien Dada',
        'El Agente #271',
        'Desde un mundo lejano, un agente alienígena es enviado para secuestrar especímenes humanos. Su objetivo era encontrar alguno adecuado para someterlos a extenuantes pruebas y experimentos. Tras múltiples escenas de terror y suspenso, el Agente #271 se toparía con Ultraman, el cual sería superior en combate en todos los aspectos. En un intento fútil, logra miniaturizar a Ultraman, pero las habilidades de este le permiten retomar su forma original y derrotarlo.',
         //Imágenes Principales
      ...
      Enemy(
        'Goldon',
        'El Devorador de Oro',
        'Las reservas de oro en una mina famosa comenzaban a escasear sin explicación aparente. Goldon era sin duda debía ser el responsable. Este Kaiju destruiría las inmediaciones en búsqueda de más y más alimento. La Patrulla Científica lograría contenerlo y derrotarlo por su cuenta, pero para variar, existía un espécimen más oculto. Aquel sería quien enfrentaría a Ultraman en un combate de resistencia para poder así rescatar a sus compañeros capturados bajo Tierra.',
         //Imágenes Principales
        ...
        aliasOf: 'El Monstruo Dorado',
        height: '65m',
        weight: '60,000T',
        planet: 'La Tierra (Ota)',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        ...
        aliasOf: 'El Monstruo Legendario',
        height: '40m',
        weight: 'Clasificado',
        planet: 'La Tierra\n(Valle Niigata)',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        ...
        aliasOf: 'La Planta Succionadora\nde Sangre',
        height: '50cm ~ 50m',
        weight: '80kg ~ 10,000T',
        planet: 'La Tierra\n(Amazonas)',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        ...
        aliasOf: 'El Alien Malicioso',
        height: '2 ~ 60m',
        weight: '40 ~ 20,000T',
        planet: 'Planeta Mephilas',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        ...
        'Residente del confortable cementerio de monstruos, puede decirse que Seabozu en vida experimentó vez tras vez el odio de una civilización dominante. Ya cansado, logró encontrar paz en la muerte, hasta que una serie de experimentos espaciales lo hicieron caer y aterrizar en la Tierra. Tras vagar con tristeza al solo recibir nuevamente odio y dolor, Seabozu anhelaba volver a descansar en su bello hogar. Ultraman lidió contra esta criatura por mucho tiempo, pero se percató de que la solución en este caso sería un tanto diferente.',
         //Imágenes Principales
        ...
        aliasOf: 'El Monstruo Fantasmal',
        height: '40m',
        weight: '30,000T',
        planet: 'Cementerio de\nMonstruos',
        ultra: '@ULTRAMAN',
        comentary: '“Cómo héroe soy consciente que he tomado vidas, seres maliciosos, peligrosos pero algunos inconscientes de sus actos. Me hago responsable por todo ello. En esta ocasión debía romper el ciclo, debía ayudarlo a que vuelva a su hogar. Aunque sinceramente hubiera sido más fácil de no ser tan testarudo”.',
      ...
      Enemy(
        'Alien Zetton',
        'El Mayor Estratega Espacial',
        "Considerados grandes estrategas militares, estos alienígenas fueron la primera amenaza a gran escala que enfrentaría la humanidad. Estudiando a los humanos presumiblemente desde los años 30, los Zetton planearían conquistar la Tierra. Aún con la variable de Ultraman tomada en cuenta, los Zetton no solo no se rindieron, sino que simplemente desarrollarían un arma capaz de derrotar al Paladín de la Justicia.",
         //Imágenes Principales
        ...
        aliasOf: 'El Fantasma Ilusorio',
        height: '2m',
        weight: '60kg',
        planet: 'Planeta Zettton',
        ultra: '@ULTRAMAN',
      ...
      Enemy(
        ...
        aliasOf: 'El Dinosaurio Espacial?',
        height: '60m',
        weight: '30,000T',
        planet: 'Planeta Zetton',
        ultra: '@ULTRAMAN',
